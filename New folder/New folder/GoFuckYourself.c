...
void empNoSortSel(struct Table table [], int s) // Sorting by employee number, Bubble Sort, Ascending.
{	int i, j;
	struct Table temp;
	for(i = 0; i < s; i++){
		for(j = i + 1; j < s; j++){
...
void meanWageSortSel(struct Table table [], int s) // Sorting by mean wage, Bubble Sort, Ascending.
{	int i, j;
	struct Table temp;
	for(i = 0; i < s; i++){
		for(j = i + 1; j < s; j++){
...
void annualWageSortSel(struct Table table [], int s)// Sorting by annual mean wage, Bubble Sort, Ascending.
{	int i, j;
	struct Table temp;
	for(i = 0; i < s; i++){
		for(j = i + 1; j < s; j++){
